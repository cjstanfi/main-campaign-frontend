...
import statsFloating from "../../assets/img/stats-floating.png";
// import stats1mb from "../../assets/img/stats1-mb.png";
import chartBox_mob from "../../assets/img/chartBox_mob-img.png";
      ...
      <div className="row m-0 position-relative header-content">
        ...
        <div className="col-sm-12 d-flex align-items-center justify-content-center order--new-0 pt-5">
          <div className="container subject ">
            ...
            <img src={stats3} className=" w-100 floating_reverse " alt="" />
            <img src={statsFloating} className="floating_img floating" alt="" />
          </div>
        </div>
      </div>
        ...
        <div className="container main-container px-sm-0 px-4 subject">
          <div className="text-center d-flex align-items-center justify-content-center flex-column">
            ...
            <div className="chartBox_mob mt-3">
              <img src={chartBox_mob} className="chartBox_mob-img" alt="" />
              <div
                ...
                >
                  <li className="nav-item" role="presentation">
                    <Link
                      ...
                      onClick={showtabnext}
                    >
                      {/* Spending */} Offline Lead Conversions
                    </Link>
                  </li>
                  <li className="nav-item" role="presentation">
                    <Link
      ...
      <div className="row m-0 p-0 position-relative plans-section mt-sm-5 mt-3 in-view section-margin">
        <div className="container main-container">
          <h2 className="color-black2 text-center">
            One plan that fits all
            {/* Small business
            <br /> and agency plans */}
          </h2>
          <div className="row m-0 p-0 position-relative mt-sm-5 mt-3 justify-content-center">
            <div
            ...
            >
              <div className="content listing-style subject">
                ...
                <ul>
                  ...
                  <li>CRM & Marketing platform integration</li>
                  <li>Full access to powerful analytics & reports</li>
                  <li>Offline lead conversion tracking</li>
                </ul>
            ...
            <div
              className="col-sm-6 mt-sm-0 mt-4 animation-element bounce-down in-view d-none"
              data-aos="fade-down"
              data-aos-duration="500"
              data-aos-easing="ease-in-out"
              data-aos-mirror="true"
