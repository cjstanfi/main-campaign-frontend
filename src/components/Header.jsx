...
import {
  marketingPlatformBusinessByNameSelector,
  setCurrentMarketingPlatformBusinessData,
...
export default function Header({
  ...
  useEffect(() => {
    if (filteredBusiness) {
      ...
      marketingPlatformBusinessData.length > 0
    ) {
      setBusinessName(
      ...
      {/* {page === "analytics" && (
        <>
          <div className="wel-analytices">
            ...
            <span className="text-thin d-block">
              Track your Facebook Data Analytics here
            </span>
          </div>
          <div className="ms-auto">
            <div className="d-flex justify-content-end align-items-center">
              <div className="d-flex time-filter-div px-1 py-2">
        ...
        <div className="me-auto d-flex m-flex-column links">
          ...
          >
            <Link
              ...
              aria-expanded="false"
              onBlur={addremoveclass}
            >
              <span className="me-auto">
                {filteredBusiness
                  ? filteredBusiness.marketingPlatformBusinessName
                  : "Business name"}
              </span>
              <svg
                className="ms-auto"
            ...
            >
              {marketingPlatformBusinessData?.map(
        ...
        {page === "dashboard" && (
          <div className="d-flex mt-sm-0 mt-3 d-t-none">
            <div className="custom-input2 h-50 w-180 ms-sm-3 d-flex align-items-center">
              <DatePickerComponent
                classname="me-auto datapickerFont"
                ndate={startDate}
                setndate={setStartDate}
